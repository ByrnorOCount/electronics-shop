...
export const getNotifications = async (req, res, next) => {
    try {
        ...
        const notifications = await notificationService.getNotificationsForUser(req.user.id, limit);
...
export const markNotificationAsRead = async (req, res, next) => {
    ...
    try {
        ...
        res.status(httpStatus.OK).json(new ApiResponse(httpStatus.OK, notification, 'Notification marked as read.'));
    } catch (error) {
        next(error);
    }
};
...
export const markAllNotificationsAsRead = async (req, res, next) => {
    ...
    try {
        ...
        res.status(httpStatus.OK).json(new ApiResponse(httpStatus.OK, null, 'All notifications marked as read.'));
    } catch (error) {
        next(error);
    }
};
