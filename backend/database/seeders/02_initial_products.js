...
export async function seed(knex) {
  ...
  await knex("products").insert([
    ...
    },
    {
      ...
      description:
        "Pack of 40 male-to-male, male-to-female, and female-to-female wires.",
      category_id: 4,
      price: 6.99,
    ...
    },
    {
      ...
      description:
        "Thumb-sized ESP32 board with Wi-Fi/BLE and battery charge support.",
      category_id: 2,
      price: 4.99,
    ...
    },
    {
      ...
      description:
        "Class 10 high-speed memory card for operating systems and storage.",
      category_id: 4,
      price: 7.99,
    ...
    },
    {
      ...
      description:
        "Low-cost microcontroller board with wireless from Raspberry Pi.",
      category_id: 2,
      price: 6.0,
    ...
    },
    {
      ...
      description:
        "A must-have kit with a wide range of common resistor values.",
      category_id: 4,
      price: 9.99,
    ...
    },
    {
      ...
      description:
        "A variety of 5mm LEDs in red, green, blue, yellow, and white.",
      category_id: 4,
      price: 5.99,
    ...
    },
    {
      ...
      description:
        "Safely connect 3.3V and 5V devices. Bi-directional, 4-channel.",
      category_id: 2,
      price: 2.25,
    ...
    },
    {
      ...
      description:
        "Connector with leads for easily powering projects with a 9V battery.",
      category_id: 3,
      price: 0.99,
  ...
  try {
    ...
    console.error(
      "Could not reset 'products_id_seq' sequence. This is expected if you are not using PostgreSQL.",
      error.message
    );
  }
}
