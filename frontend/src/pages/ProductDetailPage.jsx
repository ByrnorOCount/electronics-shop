    ...
    <div className="container mx-auto p-8">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="flex flex-col justify-center">
          ...
          <button onClick={handleAddToCart} className="bg-blue-600 text-white font-bold py-2 px-4 rounded hover:bg-blue-700 transition duration-300 w-full md:w-auto">
            Add to Cart
          </button>
        </div>
      </div>
