  ...
  if (status === 'loading') {
    ...
    content = (
      <div className="text-center bg-white p-12 rounded-lg shadow-sm">
        ...
        <p className="text-sm text-gray-500 mb-6">Add products you love to your wishlist to see them here.</p>
        <Link to="/products" className="px-6 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
          Discover Products
        </Link>
      </div>
    );
